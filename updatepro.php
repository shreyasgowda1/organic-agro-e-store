...
<html lang="en">
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>UPDATE PRODUCT DETAILS</h1>
...
?>      
                ...
                <form action="" method="post">
                  ...
                  <div class="form-group">
				   ...
				   <div class="form-group">
                    ...
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p2"  value="<?php echo $data['name']; ?>"required  placeholder="PRODUCT NAME">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT TYPE</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p3" value="<?php echo $data['type']; ?>" required  placeholder="PRODUCT TYPE">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT PHOTO</label>
                    <input class="form-control" type="FILE" aria-describedby="emailHelp" name="p4" value="<?php echo $data['photo']; ?>" required  placeholder="PRODUCT PHOTO">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT VIDEO</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p5" value="<?php echo $data['video']; ?>"required  placeholder="PRODUCT VIDEO">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT PRICE</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p6" value="<?php echo $data['price']; ?>" required  placeholder="PRODUCT PRICE">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT HEIGHT</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p7" value="<?php echo $data['height']; ?>" required  placeholder="PRODUCT HEIGHT">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT SEASON</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p8" value="<?php echo $data['season']; ?>" required  placeholder="PRODUCT SEASON">
                  </div>
                
                  <div class="form-group">
                    <label for="exampleTextarea">ABOUT PRODUCT</label>
                    <textarea class="form-control" id="exampleTextarea"  name="p9"  required  rows="3"><?php echo $data['about']; ?></textarea>
                  </div>
                 <div class="form-group">
                    <label for="exampleTextarea"> PRODUCT CARE</label>
                    <textarea class="form-control" id="exampleTextarea"  name="p10"  required  rows="3"><?php echo $data['care']; ?></textarea>
                  </div>
                 
                  <div class="form-group">
                    <label for="exampleInputEmail1">PRODUCT QUANTITY</label>
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p11" value="<?php echo $data['quantity']; ?>" required  placeholder="PRODUCT HEIGHT">
                  </div>
    ...
    <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "UPDATE product set ownername='".$_POST["p1"]."' , name='".$_POST["p2"]."', type='".$_POST["p3"]."', photo='".$_POST["p4"]."', video='".$_POST["p5"]."', price='".$_POST["p6"]."', height='".$_POST["p7"]."', season='".$_POST["p8"]."', about='".$_POST["p9"]."', care='".$_POST["p10"]."', quantity='".$_POST["p11"]."' where id='$a'";
