  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      ...
      <div class="app-sidebar__user">
        ...
        <li><a class="app-menu__item active" href="viewresponse.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Response</span></a></li>
...
$query="SELECT * FROM response where username='$a'"; // selecting data through mysql_query()
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
					...
					<td> <a href="viewqr.php?id=<?php echo $data['ownername'];?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">Pay Now  
				</a> </td>
