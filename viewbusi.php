  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active" href="viewbusi.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Utility Service</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>VIEW UTILITY SERVICE </h1>
            ...
            <section class="invoice">
			 <div class="row invoice-info">
              ...
              <div class="row invoice-info">
                ...
                <td> <a href="updatebusi.php?id=<?php echo $data['id'];?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">UPDATE    
				</a> 
				</td>
						<td> <a href="deletebusi.php?id=<?php echo $data['id'];?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">DELETE    
				</a> 
				</td>
            </section>
          </div>
