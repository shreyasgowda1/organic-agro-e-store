  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
     ...
     <ul class="app-menu">
        ...
        <li><a class="app-menu__item " href="viewusers.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Users</span></a></li>
    ...
    <main class="app-content">
      ...
      <div class="app-title">
        <div>
          <h1><i class="fa fa-edit"></i>UPDATE SERVICE DETAILS</h1>
...
$query="SELECT * from business where id = '$c'"; 
...
?>   
              ...
              <div class="col-lg-6">
                <form action="" method="post">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="TEXT" aria-describedby="emailHelp" name="p1" value="<?php echo $data['name']; ?>" required placeholder="SERVICE NAME" >
                  </div>
				   <div class="form-group">
                    <label for="exampleInputEmail1">SERVICE TYPE</label>
			<select class="form-control" id="demoSelect" value="<?php echo $data['type']; ?>" name="p2">
			  ...
			  <option value="NURSERY">NURSERY</option>
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" type="TIME" aria-describedby="emailHelp" name="p3" required value="<?php echo $data['timefrom']; ?>"  placeholder="SERVICE TIME FROM">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">SERVICE TIME TO</label>
                    <input class="form-control" type="TIME" aria-describedby="emailHelp" name="p4" required value="<?php echo $data['timeto']; ?>"  placeholder="SERVICE TIME TO">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">SERVICE IMAGE</label>
                    <input class="form-control" type="FILE" aria-describedby="emailHelp" name="p5" required value="<?php echo $data['image']; ?>"  placeholder="SERVICE IMAGE">
                  </div>
				  <div class="form-group">
                    <label for="exampleInputEmail1">SERVICE CITY</label>
								<select class="form-control" id="demoSelect" value="<?php echo $data['city']; ?>" name="p6">
				  ...
				  <div class="form-group">
                    ...
                    <textarea class="form-control" type="TEXT" aria-describedby="emailHelp" name="p7"  id="autocomplete" rows="3" required onFocus="geolocate()" placeholder="SERVICE ADDRESS"><?php echo $data['address']; ?></textarea>
                  </div>
				<script>
      ...
      function geolocate() {
        ...
        async defer></script>
                  <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleTextarea"  name="p8" required  placeholder="ABOUT BUSINESS" rows="3"><?php echo $data['about']; ?></textarea>
                  </div>
    ...
    <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "update business set name='".$_POST["p1"]."', type='".$_POST["p2"]."', timefrom='".$_POST["p3"]."', timeto='".$_POST["p4"]."', image='".$_POST["p5"]."', city='".$_POST["p6"]."', address='".$_POST["p7"]."', about='".$_POST["p8"]."'";
