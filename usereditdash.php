...
<html lang="en">
  ...
  <style>
    ...
    <title>DIGITAL MAKETING FOR FARMERS</title>
  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <main class="app-content">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="tile">
            <h3 class="tile-title">ABOUT DIGITAL MARKETING FOR FARMERS</h3>
            <ul>
 <li>Greenzone - best farmer responsive app for online shopping in Mysore. Buy plants, seeds,
...
<?php } ?> 
	  ...
	  <?php
         if(isset($_POST["submit"])){
            ...
            $sql = "update users set firstname='".$_POST["p1"]."',secondname='".$_POST["p2"]."',phone='".$_POST["p3"]."',email='".$_POST["p4"]."',address='".$_POST["p7"]."',city='".$_POST["p8"]."',blood='".$_POST["p9"]."' where username='".$_POST["p4"]."'";
		...
		<script type="text/javascript">
            ...
            window.location="usereditdash.php";
            </script>
			<?php 
