...
<html lang="en">
 ...
 <ul class="app-menu">
        ...
        <li><a class="app-menu__item " href="viewowner.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Farmer</span></a></li>
...
$query="SELECT * FROM users"; // selecting data through mysql_query()
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <tr>
					...
					<td> <a href="deleteuser.php?id=<?php echo $data['username'];?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">DELETE    
				</a> 
				</td>
