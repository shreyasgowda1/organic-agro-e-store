  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      ...
      <div class="app-sidebar__user">
		...
		<li><a class="app-menu__item active" href="viewownernoti.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View Owner Notifications</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
          <h1><i class="fa fa-dashboard"></i>View Owner Notifications </h1>
...
$query="SELECT * FROM ownernoti"; // selecting data through mysql_query()
