...
src="<?php echo $data['video']; ?>">
              ...
              <div class="row invoice-info">
                <div class="col-4">PRICE / Kg
			
                  <address><strong><h2>&#8377 <?php echo $data['price']; ?></h2></strong><br>Height:<?php echo $data['height']; ?><br>Season:<?php echo $data['season']; ?><br><?php echo $data['specilisation']; ?></address>
                </div>
                <div class="col-4">Quantity
			
                 <strong><h2><?php echo $data['quantity']; ?> Kgs</h2></strong><br>
                </div> 
              
              </div>
                <td> <a href="updatepro.php?id=<?php echo $data['id'];?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">UPDATE    
				</a> 
				</td>
						<td> <a href="deletepro.php?id=<?php echo $data['id'];?>" class="btn btn-sm btn-primary login-submit-cs" onclick="return confirm('Are You Sure')">DELETE    
				</a> 
				</td>
            </section>
          </div>
