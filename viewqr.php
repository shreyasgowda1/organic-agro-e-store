  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
     ...
     <ul class="app-menu">
		...
		<li><a class="app-menu__item " href="searchbusiness.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">Search Business</span></a></li>       
...
?>
      <div class="clearfix"></div>
        ...
        <div class="form-group row">
                  <label class="control-label col-md-3">Scan By Using PhonePe or Google Pay </label>
                  <div class="col-md-8">
